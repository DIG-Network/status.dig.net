...
export const TARGETS = [
  ...
  },
  {
    ...
    category: 'Read path',
    description:
      'Subdomain resolver — serves published store content per subdomain (branded loader + client-side decrypt).',
    kind: 'http',
  ...
  },
  {
    ...
    category: 'Control plane',
    description:
      'Bug-report intake API (auto-report → S3 + GitHub issues) every DIG frontend embeds.',
    kind: 'http',
